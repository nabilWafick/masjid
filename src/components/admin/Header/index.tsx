...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-amber-500 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
        ...
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" href="/">
            {/* <Image
              ...
              alt="Logo"
            /> */}
            <h1 className="font-semibold">Mosquée Darou SALAM</h1>
          </Link>
        </div>
