      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink href="/mosque">
              <div className="block px-3 py-2 text-purple-800 hover:bg-purple-100 rounded-md">
                {t.mosque}
              </div>
            </NavLink>
            <NavLink href="/news">
            ...
            <div className="px-3 py-2">
              <div className="flex flex-col space-y-2">
                <button
                  onClick={() => changeLanguage("en")}
                  className="text-left text-purple-800 hover:bg-purple-100 rounded-md px-2 py-1"
                >
                  English
                </button>
                <button
